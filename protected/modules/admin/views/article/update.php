...
<div class="panel panel-default">
    ...
    <div class="panel-body">
                ...
                <div class="col-lg-6 col-md-7 col-sm-7">
                    <select class="form-control" name="Article[tag_id]">
                        <?php foreach ($label as $v) { ?>
                            <option value="<?php echo $v->id; ?>" <?php echo $data['tag_id'] == $v->id ? 'selected' : ''; ?>><?php echo $v->value; ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2" style="color:orangered;font-size: 0.8rem;line-height:34px">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-lg-2 col-md-3$v->id col-sm-3" align="right" style="line-height:34px">
        ...
        <input type='hidden' name="id" id="back_id" value="<?php $_REQUEST['id']?>"/>
        <div class="row">
...
<script>
    window.onload = function(){
        var testEditor;
        $(function() {
            $.get("<?php echo $data['path']?>", function(md){
